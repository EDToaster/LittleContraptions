package dev.murad.littlecontraptions.entity.models;
...
public class ContraptionBargeModel extends EntityModel<ContraptionBargeEntity> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(LCMod.MOD_ID, "contraptionbargemodel"), "main");
    private final ModelPart bb_main;
    private final ModelPart bb_main2;

    public ContraptionBargeModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(ContraptionBargeEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
