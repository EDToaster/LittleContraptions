...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(LLBlocks.TUG_DOCK.get(), 2)
        ...
        ShapedRecipeBuilder.shaped(LLBlocks.BARGE_DOCK.get(), 2)
                .define('#', ModItems.SPRING.get())
                .define('_', Tags.Items.STONE)
                .define('$', Items.IRON_INGOT)
                .pattern("___")
        ...
        ShapedRecipeBuilder.shaped(LLBlocks.VESSEL_DETECTOR.get(), 2)
                .define('#', ModItems.SPRING.get())
                .define('_', Tags.Items.STONE)
        ...
        ShapedRecipeBuilder.shaped(LLBlocks.GUIDE_RAIL_CORNER.get(), 3)
                .define('#', ModItems.SPRING.get())
                .define('_', Tags.Items.STONE)
        ...
        ShapedRecipeBuilder.shaped(LLBlocks.GUIDE_RAIL_TUG.get(), 8)
                .define('#', ModItems.SPRING.get())
                .define('_', Tags.Items.STONE)
                .define('$', Items.POWERED_RAIL)
                .pattern("#$#")
        ...
        ShapedRecipeBuilder.shaped(LLBlocks.FLUID_HOPPER.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(LLBlocks.VESSEL_CHARGER.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(ModItems.ENERGY_TUG.get())
                .define('_', Items.PISTON)
                .define('#', LLBlocks.VESSEL_CHARGER.get())
                .define('$', Items.IRON_INGOT)
                .pattern(" $ ")
                .pattern("_#_")
                .pattern("$$$")
