...
public class ModLootTableProvider extends LootTableProvider {
    ...
    public static class ModBlockLootTables extends BlockLoot {
        ...
        protected void addTables() {
            dropSelf(LLBlocks.TUG_DOCK.get());
            dropSelf(LLBlocks.BARGE_DOCK.get());
            dropSelf(LLBlocks.GUIDE_RAIL_CORNER.get());
            dropSelf(LLBlocks.GUIDE_RAIL_TUG.get());
            dropSelf(LLBlocks.FLUID_HOPPER.get());
            dropSelf(LLBlocks.VESSEL_CHARGER.get());
            dropSelf(LLBlocks.VESSEL_DETECTOR.get());
        }
