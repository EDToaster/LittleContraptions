package ca.edtoaster.littlecontraptions.entity.models;
...
public class ContraptionBargeModel extends EntityModel<ContraptionBargeEntity> {
    ...
    @Override
    public void setupAnim(ContraptionBargeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
