package dev.murad.littlelogistics.entity.custom.tug;

import dev.murad.littlelogistics.setup.LLSounds;
...
public abstract class AbstractTugEntity extends VesselEntity implements LinkableEntityHead<VesselEntity>, SpringableEntity, Container, WorldlyContainer {
    ...
    protected void onDock() {
        this.playSound(LLSounds.TUG_DOCKING.get(), 0.6f, 1.0f);
    }

    protected void onUndock() {
        this.playSound(LLSounds.TUG_UNDOCKING.get(), 0.6f, 1.5f);
    }
