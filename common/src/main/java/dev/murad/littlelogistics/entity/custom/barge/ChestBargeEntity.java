package dev.murad.littlelogistics.entity.custom.barge;

import dev.murad.littlelogistics.setup.LLEntityTypes;
import dev.murad.littlelogistics.setup.LLItems;
...
public class ChestBargeEntity extends AbstractBargeEntity implements Container, MenuProvider, WorldlyContainer {
    ...
    public ChestBargeEntity(Level worldIn, double x, double y, double z) {
        super(LLEntityTypes.CHEST_BARGE.get(), worldIn, x, y, z);
    }
    ...
    public Item getDropItem() {
        return LLItems.CHEST_BARGE.get();
    }
